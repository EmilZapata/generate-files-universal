...
export class __entity__(pascalCase)PostgresRepository implements __entity__(pascalCase)Repository {
  ...
  create(body: Partial<__entity__(pascalCase)Type>): Promise<__entity__(pascalCase)Model> {
    try {
  ...
  async update(id: number, changes: Partial<__entity__(pascalCase)Type>): Promise<__entity__(pascalCase)Model> {
    try {

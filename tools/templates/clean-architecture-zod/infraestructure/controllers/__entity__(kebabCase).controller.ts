...
import { Create__entity__(pascalCase)ReqDtoType } from "../dto/request/__entity__(kebabCase)/create-__entity__(kebabCase).request.dto";
import { Table__entity__(pascalCase)ReqDtoType } from "../dto/request/__entity__(kebabCase)/table-__entity__(kebabCase).request.dto";
import { Update__entity__(pascalCase)ReqDtoType } from "../dto/request/__entity__(kebabCase)/update-__entity__(kebabCase).request.dto";
...
export class __entity__(pascalCase)Controller {
  ...
  @Get('select')
  async getSelect(@Query() search?: SelectQueryDtoType) {
  ...
  @Post("table")
  table(@Body() body: Table__entity__(pascalCase)DtoType) {
  ...
  @Post()
  create(@Body() body: Create__entity__(pascalCase)ReqDtoType, @UserLogged() userLogged: IUserLogged) {
  ...
  @Patch(":id")
  update(@Param("id", ParseIntPipe) id: number, @Body() body: Update__entity__(pascalCase)ReqDtoType, @UserLogged() userLogged: IUserLogged) {
  ...
  @Put("/change-status")
  changeStatus(@Body() body: ChangeStatusReqDtoType, @UserLogged() userLogged: IUserLogged) {

...
import { Select__entity__(pascalCase)UseCase } from '@__module__(camelCase)/application/use-cases/__entity__(kebabCase)/select-__entity__(kebabCase).__entity__(kebabCase)case';
